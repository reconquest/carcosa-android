...
/**
 * Helper class that provides methods for generating and accessing secret keys, and showcases the
 * differences between the keys that require biometrics and the keys bound to user credentials.
 */
...
final class BiometricPromptDemoSecretKeyHelper {
  ...
  static void generateBiometricBoundKey(String keyName, boolean invalidatedByBiometricEnrollment)
